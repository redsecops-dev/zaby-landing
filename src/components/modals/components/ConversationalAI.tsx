...
const channels = [
  ...
  { name: "SMS", icon: "lucide:message-square", x: 300, y: 30, color: "#1e293b" },
...
const HeroSection = () => {
  ...
  return (
    <section ref={containerRef} className="relative min-h-screen flex flex-col items-center justify-center py-24 overflow-hidden bg-white">
      {/* Background Effects */}
      ...
      <div className="relative w-full max-w-5xl mx-auto px-6 lg:px-8 z-10 text-center flex flex-col items-center">
        ...
        >
          Unify every customer <span className="bg-linear-to-br from-accent via-[#c026d3] to-accent-soft bg-clip-text text-transparent font-light">conversation</span>
        </motion.h1>
        ...
        <div className="relative mt-20 w-full max-w-4xl aspect-[16/9] sm:aspect-[900/400]">
          ...
          {channels.map((ch, i) => (
            ...
            >
              ...
              <span className="text-[10px] uppercase tracking-widest text-slate-400 font-bold">{ch.name}</span>
            </div>
          ))}
          ...
          <div className="absolute top-[85%] left-1/2 -translate-x-1/2 -translate-y-1/2 z-20 flex flex-col items-center gap-4">
            ...
            <div className="flex flex-col items-center">
              <span className="text-xs font-bold text-slate-900 uppercase tracking-[0.2em]">Zaby Conversational Runtime</span>
              <div className="flex items-center gap-2 mt-1">
                <div className="w-1.5 h-1.5 rounded-full bg-blue-600 animate-pulse" />
                <span className="text-[10px] text-blue-600/80 font-bold uppercase tracking-widest">Operational Core Active</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-40">
          ...
          <h2 className="text-5xl md:text-7xl font-light text-slate-900 tracking-tight leading-none mb-8">
            Beyond <span className="bg-linear-to-br from-accent via-[#c026d3] to-accent-soft bg-clip-text text-transparent font-light">simple chat.</span>
          </h2>
          <p className="text-xl text-slate-500 font-light max-w-2xl mx-auto">
            Experience a new standard in autonomous communication infrastructure.
          </p>
        </div>
        ...
        <div className="relative">
          ...
          >
            ...
            <h3 className="text-4xl md:text-5xl font-medium text-slate-900 mb-6 tracking-tight">WhatsApp AI Agents</h3>
            <p className="text-lg text-slate-600 leading-relaxed font-light mb-8">
              Deploy autonomous agents that handle complex customer inquiries directly on WhatsApp. 
              From order tracking to technical support—integrated with your CRM in real-time.
            </p>
          ...
          >
            <div className="absolute inset-x-0 top-0 h-14 bg-slate-50 border-b border-slate-100 flex items-center px-6 justify-between">
               <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-full bg-green-500 flex items-center justify-center text-white font-bold text-[10px]">Z</div>
                  <span className="text-xs font-bold text-slate-700 uppercase tracking-widest">WhatsApp Agent</span>
               </div>
            ...
            <div className="p-8 space-y-6 pt-20">
               <div className="bg-slate-50 rounded-2xl rounded-tl-none p-4 max-w-[80%] text-sm text-slate-600 font-medium leading-relaxed">
                  Hi! I'm your Zaby-powered agent. How can I assist you with your enterprise workflows today?
               </div>
               <motion.div 
               ...
               <motion.div 
                ...
                >
                  <div className="flex items-center gap-2 mb-2 text-blue-600">
                    ...
                    <span className="text-[10px] font-bold uppercase tracking-widest">Executing: Workflow Sync</span>
                  </div>
                  Certainly. I have synchronized 4 orders with the finance stack. Need anything else?
               </motion.div>
            </div>
          </motion.div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-20 items-center mb-60 group">
             ...
             <div className="relative h-[400px] flex items-center justify-center">
                ...
                <div className="flex items-center justify-center w-full">
                  ...
                  <div className="flex items-center justify-end gap-1.5 w-1/3">
                    {[40, 60, 100, 140, 80, 120, 160, 110, 70, 50].map((h, i) => (
                      <motion.div
                        key={`lw-${i}`}
                  ...
                  <div className="flex items-center justify-start gap-1.5 w-1/3">
                    {[50, 70, 110, 160, 120, 80, 140, 100, 60, 40].map((h, i) => (
                      <motion.div
                        key={`rw-${i}`}
                        className="w-1.5 bg-blue-500/40 rounded-full"
                        animate={{
          ...
          >
            ...
            <h3 className="text-4xl md:text-5xl font-medium text-slate-900 mb-6 tracking-tight">Voice Automation</h3>
            <p className="text-lg text-slate-600 leading-relaxed font-light mb-8">
              Real-time AI voice systems with ultra-low latency. Conduct autonomous calls, handle IVR requests, 
              and provide human-like support 24/7.
            </p>
            <div className="flex items-center gap-6">
               <div className="flex flex-col gap-1">
                  <span className="text-2xl font-bold text-slate-900 tracking-tight">14ms</span>
                  <span className="text-[10px] uppercase font-bold text-slate-400 tracking-widest">Processing Latency</span>
               </div>
               <div className="w-px h-10 bg-slate-200" />
               <div className="flex flex-col gap-1">
                  <span className="text-2xl font-bold text-slate-900 tracking-tight">HD</span>
                  <span className="text-[10px] uppercase font-bold text-slate-400 tracking-widest">Neural Audio</span>
               </div>
            </div>
          </motion.div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-20 items-center mb-60 group">
          ...
          >
            ...
            <h3 className="text-4xl md:text-5xl font-medium text-slate-900 mb-6 tracking-tight">Multi-channel Memory</h3>
            <p className="text-lg text-slate-600 leading-relaxed font-light mb-8">
              A unified memory layer that spans every platform. When a user switches from Slack to WhatsApp, 
              your AI maintains absolute context without repeating questions.
            </p>
            <div className="space-y-4">
               {["Persistent User State", "Cross-Platform Sync", "Semantic Search"].map((item, i) => (
                 <div key={i} className="flex items-center gap-4 group/item">
                    <div className="w-10 h-10 rounded-xl bg-white border border-slate-100 flex items-center justify-center shadow-sm group-hover/item:border-purple-300 transition-colors">
                      <Icon icon="solar:check-read-linear" className="text-purple-600" />
                    </div>
          ...
          <div className="relative">
            <div className="grid grid-cols-2 gap-4">
               {[
                 { label: "User Intent", color: "bg-blue-500", icon: <Icon icon="solar:brain-bold-duotone" className="text-blue-500" />, code: '{ intent: "cancel_order", confidence: 0.98 }', delay: 0 },
                 { label: "Preferences", color: "bg-purple-500", icon: <Icon icon="solar:settings-bold-duotone" className="text-purple-500" />, code: '{ locale: "en-US", tier: "enterprise" }', delay: 0.1 },
                 { label: "Interaction History", color: "bg-indigo-500", icon: <Icon icon="solar:history-bold-duotone" className="text-indigo-500" />, code: '{ channels: ["WhatsApp", "Slack"] }', delay: 0.2 },
                 { label: "Workflow State", color: "bg-slate-900", icon: <Icon icon="solar:programming-bold-duotone" className="text-slate-700" />, code: '{ active_step: 3, status: "executing" }', delay: 0.3 }
               ].map((card, i) => (
                 <motion.div
                   key={i}
                 ...
                 >
                   <div className="flex justify-between items-start">
                     <div className={`w-8 h-8 rounded-lg ${card.color} bg-opacity-10 border border-current flex items-center justify-center text-sm`}>
                       {card.icon}
                     </div>
        ...
        <div className="text-center">
          ...
          <h3 className="text-5xl md:text-7xl font-medium text-slate-900 mb-12 tracking-tight leading-none">
            Enterprise <span className="bg-linear-to-br from-accent via-[#c026d3] to-accent-soft bg-clip-text text-transparent">Routing</span>
          </h3>
          <p className="text-xl text-slate-500 font-light max-w-3xl mx-auto mb-20 leading-relaxed">
            Intelligent agent handoffs and multi-tier communication logic that scales with your organizational complexity. 
            Route inquiries to the perfect autonomous unit instantly.
          </p>
          <div className="relative max-w-5xl mx-auto aspect-[900/450] bg-slate-950 rounded-[3rem] overflow-hidden shadow-2xl group border border-white/10">
             ...
             <svg viewBox="0 0 900 450" className="absolute inset-0 w-full h-full pointer-events-none z-0">
                <defs>
                  <linearGradient id="glow-grad-left" x1="0%" y1="0%" x2="100%" y2="0%">
                    <stop offset="0%" stopColor="#10b981" stopOpacity="0.1" />
                    <stop offset="100%" stopColor="#a855f7" stopOpacity="0.8" />
                  </linearGradient>
                  <linearGradient id="glow-grad-right" x1="0%" y1="0%" x2="100%" y2="0%">
                ...
                <path d="M 270 120 C 350 120, 360 225, 450 225" stroke="rgba(255,255,255,0.04)" strokeWidth="2" fill="none" />
                <motion.path
                ...
                <path d="M 270 330 C 350 330, 360 225, 450 225" stroke="rgba(255,255,255,0.04)" strokeWidth="2" fill="none" />
                <motion.path
                  ...
                  fill="none"
                  animate={{ strokeDashoffset: [0, -32] }}
                  transition={{ repeat: Infinity, ease: "linear", duration: 2.5, delay: 0.5 }}
                />

                {/* Right AI Agent connection */}
                <path d="M 450 225 C 540 225, 550 90, 630 90" stroke="rgba(255,255,255,0.04)" strokeWidth="2" fill="none" />
                <motion.path
                ...
                <path d="M 450 225 H 630" stroke="rgba(255,255,255,0.04)" strokeWidth="2" fill="none" />
                <motion.path
                  d="M 450 225 H 630"
                  stroke="url(#glow-grad-right)"
                  strokeWidth="2"
                  ...
                  fill="none"
                  animate={{ strokeDashoffset: [0, 32] }}
                  transition={{ repeat: Infinity, ease: "linear", duration: 2, delay: 0.2 }}
                />

                {/* Right DB connection */}
                <path d="M 450 225 C 540 225, 550 360, 630 360" stroke="rgba(255,255,255,0.04)" strokeWidth="2" fill="none" />
                <motion.path
                  ...
                  fill="none"
                  animate={{ strokeDashoffset: [0, 32] }}
                  transition={{ repeat: Infinity, ease: "linear", duration: 3.5, delay: 0.4 }}
                />
             </svg>
             ...
             <div className="absolute inset-0 w-full h-full z-10 flex items-center justify-between px-12 select-none">
                ...
                <div className="flex flex-col gap-12 w-[240px] text-left">
                   ...
                   >
                     ...
                     <div className="flex-1 min-w-0">
                       <div className="flex items-center gap-1.5 justify-between">
                         <span className="text-[10px] font-bold text-emerald-400 uppercase tracking-wider">Inbound Msg</span>
                         <span className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse" />
                       </div>
                       <h4 className="text-xs font-bold text-white mt-0.5 truncate">WhatsApp Channel</h4>
                       <p className="text-[9px] text-slate-400 mt-1 font-mono truncate">"Cancel subscription plan..."</p>
                     </div>
                   </motion.div>
                   ...
                   >
                     ...
                     <div className="flex-1 min-w-0">
                       <div className="flex items-center gap-1.5 justify-between">
                         <span className="text-[10px] font-bold text-blue-400 uppercase tracking-wider">Voice Call</span>
                         <span className="w-1.5 h-1.5 rounded-full bg-blue-500 animate-pulse" />
                       </div>
                       <h4 className="text-xs font-bold text-white mt-0.5 truncate">Direct Audio Ingest</h4>
                ...
                <div className="flex flex-col items-center justify-center relative">
                   ...
                   <div className="relative w-28 h-28 bg-linear-to-br from-purple-500 to-indigo-600 rounded-full flex flex-col items-center justify-center shadow-[0_0_50px_rgba(168,85,247,0.4)] border border-purple-400/30 z-10 select-none">
                      ...
                      <span className="text-[9px] font-bold text-purple-200 uppercase tracking-[0.2em] mt-2">ZABY AI</span>
                      <span className="text-[8px] font-medium text-purple-300 uppercase tracking-widest mt-0.5">ROUTER</span>
                   </div>
                   ...
                   <div className="absolute top-[130px] flex flex-col items-center whitespace-nowrap bg-slate-900/90 border border-white/10 rounded-full px-3 py-1 mt-2 backdrop-blur-sm">
                      <div className="flex items-center gap-1.5">
                         ...
                         <span className="text-[8px] font-bold text-slate-300 uppercase tracking-widest">Routing intent resolved (99.2%)</span>
                      </div>
                   </div>
                </div>
                ...
                <div className="flex flex-col gap-8 w-[240px] text-left">
                   ...
                   >
                     ...
                     <div className="flex-1 min-w-0">
                       <div className="flex items-center gap-1.5 justify-between">
                         <span className="text-[9px] font-bold text-emerald-400 uppercase tracking-wider bg-emerald-500/10 px-1.5 py-0.5 rounded font-mono">Execute</span>
                       </div>
                       <h4 className="text-xs font-bold text-white mt-1 truncate">RENO AI Runtime</h4>
                       <p className="text-[9px] text-slate-400 font-medium mt-0.5 truncate">Autonomous CRM Resolve</p>
                     </div>
                   </motion.div>
                   ...
                   >
                     ...
                     <div className="flex-1 min-w-0">
                       <div className="flex items-center gap-1.5 justify-between">
                         <span className="text-[9px] font-bold text-blue-400 uppercase tracking-wider bg-blue-500/10 px-1.5 py-0.5 rounded font-mono">Queue</span>
                       </div>
                       <h4 className="text-xs font-bold text-white mt-1 truncate">Tier 2 Support Queue</h4>
                       <p className="text-[9px] text-slate-400 font-medium mt-0.5 truncate">Human Escalation Resolved</p>
                     </div>
                   </motion.div>
                   ...
                   >
                     ...
                     <div className="flex-1 min-w-0">
                       <div className="flex items-center gap-1.5 justify-between">
                         <span className="text-[9px] font-bold text-purple-400 uppercase tracking-wider bg-purple-500/10 px-1.5 py-0.5 rounded font-mono">Trigger</span>
                       </div>
                       <h4 className="text-xs font-bold text-white mt-1 truncate">Database Automation</h4>
                       <p className="text-[9px] text-slate-400 font-medium mt-0.5 truncate">Sync Stripe Billing Stack</p>
                     </div>
                   </motion.div>
                </div>
             </div>
            ...
            <div className="absolute inset-12 flex flex-col gap-6">
              <div className="h-1/3 w-full rounded-2xl border border-slate-200 bg-white/80 p-6 backdrop-blur-sm shadow-sm">
                <div className="flex justify-between items-center mb-4">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] font-bold uppercase tracking-widest text-slate-500">Live Stream</span>
                  </div>
                  <span className="text-[10px] font-medium text-slate-400 tracking-tighter">ID: ZX-902</span>
                </div>
              ...
              <div className="flex-1 grid grid-cols-2 gap-6">
                <div className="rounded-2xl border border-slate-200 bg-white/80 p-6 backdrop-blur-sm flex flex-col justify-between shadow-sm">
                  ...
                  <div className="text-2xl font-semibold text-slate-900 tracking-tighter">Positive (98%)</div>
                </div>
                <div className="rounded-2xl border border-slate-200 bg-white/80 p-6 backdrop-blur-sm flex flex-col justify-between shadow-sm">
                  <span className="text-[10px] font-bold uppercase tracking-widest text-slate-400">Latency</span>
                  <div className="text-2xl font-semibold text-blue-600 tracking-tighter">14ms</div>
                </div>
              </div>
              ...
              <div className="h-1/4 w-full rounded-2xl border border-blue-600/20 bg-white p-6 backdrop-blur-sm flex items-center justify-between group-hover:border-blue-600 transition-colors shadow-sm">
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-sm font-semibold text-slate-900">Trigger Workflow: Order Sync</span>
                </div>
    ...
    <section className="relative py-40 bg-white px-6 text-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center">
        <h2 className="text-3xl sm:text-5xl md:text-6xl font-light text-slate-900 tracking-tight leading-[1.1] glass-text">
          Deploy conversational AI systems that <span className="bg-linear-to-br from-accent via-[#c026d3] to-accent-soft bg-clip-text text-transparent font-light">operate</span> beyond chat.
        </h2>
        ...
        <div className="mt-12 flex flex-col sm:flex-row gap-4 items-center">
          <Link href="https://platform.zaby.io/signup" className="group relative flex w-full cursor-pointer items-center justify-center gap-3 rounded-full bg-(--color-button-primary-bg) px-8 py-6 text-md font-medium tracking-wide text-white shadow-[rgba(76,29,149,0.5)_0px_10px_30px_-10px] transition-all hover:bg-(--color-button-primary-hover) hover:shadow-[rgba(76,29,149,0.6)_0px_12px_34px_-10px] sm:w-auto">
            Start Building
          </Link>
          <button onClick={() => router.push("https://platform.zaby.io/signup")}
