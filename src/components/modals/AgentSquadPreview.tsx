...
export function AgentSquadPreview() {
  ...
  return (
    <div className="w-full min-h-full h-auto bg-slate-50/20 text-slate-800 font-sans antialiased p-8 flex flex-col gap-12 relative overflow-hidden">
      {/* Background subtle grid & global gradient orbs */}
      {/* <GridBackground variant="dots" opacity="light" /> */}
      {/* <GradientOrb color="purple" size="xl" className="-top-40 -left-40 opacity-15" /> */}
      {/* <GradientOrb color="pink" size="xl" className="top-1/2 -right-40 opacity-15" /> */}
      ...
      >
        {/* <GridBackground variant="dots" opacity="light" /> */}
        {/* <GradientOrb color="purple" size="lg" className="top-1/4 left-1/4 -translate-x-1/2 -translate-y-1/2 opacity-20" /> */}
        {/* Hero Video */}
        <motion.div
          style={{
            WebkitMaskImage:
      ...
      <section
        className={`relative min-h-[70vh] w-full flex flex-col items-center justify-center py-24 px-10 md:px-20 overflow-hidden transition-colors duration-500 bg-slate-50/20 backdrop-blur-md border border-slate-200/20 rounded-3xl p-10 my-8`}
      >
        {/* <GridBackground variant="dots" opacity="light" /> */}
        {/* <GradientOrb color="purple" size="xl" className="top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-20" /> */}
        ...
        <div className="w-full max-w-5xl relative z-10 grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
          ...
          <div className="md:col-span-5 space-y-6">
            ...
            <p
              className={`font-light text-base leading-relaxed transition-colors text-slate-600`}
            >
              Phantom is the ultimate enterprise workforce orchestrator,
              specifically engineered to automate high-density bulk work with
              lightning velocity and complete custom integration.
            </p>
          </div>
          ...
          <div className="md:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-4">
            <MotionGlassPanel
              ...
              padding="lg"
              className="transition-all duration-300 group hover:shadow-[0_0_30px_rgba(232, 121, 249, 0.15)] bg-white/70 hover:bg-white/95 cursor-pointer"
            >
              <div className="h-10 w-10 rounded-xl bg-purple-500/10 flex items-center justify-center text-purple-500 mb-5 border border-purple-500/20 group-hover:bg-purple-500/20 group-hover:text-purple-600 transition-all duration-300">
                <svg
                  className="w-5 h-5"
                  fill="none"
                  viewBox="0 0 24 24"
              ...
              <h3
                className={`text-sm font-medium mb-2 tracking-wide uppercase transition-colors text-slate-900`}
              >
                Fast & Efficient
              </h3>
              <p
                className={`text-xs font-light leading-relaxed transition-colors text-slate-500`}
              >
                Hyper-optimized computational execution paths guarantee
                ultra-fast, zero-overhead task cycles for all synchronized
            ...
            >
              ...
              <p
                className={`text-xs font-light leading-relaxed transition-colors text-slate-500`}
              >
                Engineered with resilient, self-healing nodes providing a
                reliable system structure built to execute massive scales of
                production bulk work consistently.
              </p>
            </MotionGlassPanel>
          </div>
        </div>
      ...
      {/* Section 2: Clock */}
      <section
        className={`relative h-screen w-full flex items-center px-10 md:px-20 transition-colors duration-500 bg-transparent`}
      >
        {/* <GridBackground variant="dots" opacity="light" /> */}
        {/* <GradientOrb color="pink" size="lg" className="left-1/3 top-1/2 -translate-x-1/2 -translate-y-1/2 opacity-15" /> */}
        <div className="grid grid-cols-1 md:grid-cols-2 w-full items-center">
          ...
          <div className="flex flex-col space-y-4 pl-0 md:pl-12">
            ...
            <p
              className={`max-w-md font-light leading-relaxed transition-colors text-slate-500`}
            >
              Continuous neural synchronization ensuring your digital workforce
      ...
      >
        {/* <GridBackground variant="dots" opacity="light" /> */}
        {/* <GradientOrb color="purple" size="lg" className="right-1/3 top-1/2 -translate-x-1/2 -translate-y-1/2 opacity-15" /> */}
        <div className="grid grid-cols-1 md:grid-cols-2 w-full items-center gap-12">
          <div className="flex flex-col space-y-8 order-2 md:order-1">
            ...
            <p
              className={`max-w-md font-light leading-relaxed transition-colors text-slate-500`}
            >
              A decentralized intelligence mesh connecting nodes across every
              continent, powering local decisions with global wisdom.
            </p>
          </div>
      ...
      {/* Section 5: CTA */}
      <section
        className={`relative min-h-[90vh] w-full flex flex-col items-center justify-center py-20 space-y-8 overflow-hidden transition-colors duration-500 bg-transparent`}
      >
        {/* <GridBackground variant="dots" opacity="light" /> */}
        {/* <GradientOrb color="purple" size="xl" className="left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 opacity-15" /> */}
        ...
        >
          <h2 className="text-4xl font-light tracking-tight glass-text">
            Ready to evolve?
          </h2>
          <p className={`font-light transition-colors text-slate-600`}>
            Deploy your first Phantom today.
          </p>
        </motion.div>
        ...
        <ShimmerButton
          ...
          className="z-20 px-12 py-4 text-base font-semibold tracking-tight hover:shadow-[0_0_40px_rgba(232, 121, 249, 0.35)] transition-all duration-300 active:scale-95"
        >
          Deploy now
        </ShimmerButton>
        ...
        <div
          className={`absolute bottom-10 text-[10px] tracking-[1em] uppercase z-20 transition-colors text-slate-900/70`}
        >
