...
const rainbowButtonVariants = cva(
  cn(
    ...
    "rounded-full outline-none focus-visible:ring-[3px] aria-invalid:border-destructive", // changed rounded-sm to rounded-full to match pill style of the other CTA buttons
  ...
  ),
  {
    variants: {
      ...
      size: {
        default: "h-11 px-8 py-2", // configured default height and padding to match "Get Started" size (px-10 py-4 in custom style, h-11 px-8 fits this well)
